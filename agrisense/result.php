...
<body>
    ...
    echo "<script>alert($algorithm);</script>";

    $_SESSION['nitrogen'] = $nitrogen;
    $_SESSION['phosphorus'] = $phosphorus;
    $_SESSION['potassium'] = $potassium;
    ...
    if ($algorithm == 'randomForest') {
        $python_command = "python3 randomForestPickle.py $nitrogen $phosphorus $potassium $temperature $humidity $ph $rainfall 2>&1";
        // $python_command = "python3 final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
        //$python_command = "python3 machineLearning/final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
    

        // Execute the Python script and capture the output
        $response = shell_exec($python_command);

        $responseArray = explode(',', $response);

        $recommended_crop = $responseArray[0];
        $confidence = (double) $responseArray[1];
        $season = $responseArray[2];
        $ml = $responseArray[3];


        $_SESSION["recommended_crop"] = $recommended_crop;
        $_SESSION["confidence"] = $confidence;
        $_SESSION["season"] = $season;
        $_SESSION["ml"] = $ml;
    }
    if ($algorithm == 'bagging') {
        $python_command = "python3 baggingPickle.py $nitrogen $phosphorus $potassium $temperature $humidity $ph $rainfall 2>&1";
        // $python_command = "python3 final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
        //$python_command = "python3 machineLearning/final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
    ...
    if ($algorithm == 'knn') {
        $python_command = "python3 knnPickle.py $nitrogen $phosphorus $potassium $temperature $humidity $ph $rainfall 2>&1";
        // $python_command = "python3 final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
        //$python_command = "python3 machineLearning/final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
    ...
    if ($algorithm == 'logReg') {
        $python_command = "python3 logRegPickle.py $nitrogen $phosphorus $potassium $temperature $humidity $ph $rainfall 2>&1";
        // $python_command = "python3 final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
        //$python_command = "python3 machineLearning/final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
    ...
    if ($algorithm == 'svm') {
        $python_command = "python3 svmPickle.py $nitrogen $phosphorus $potassium $temperature $humidity $ph $rainfall 2>&1";
        // $python_command = "python3 final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
        //$python_command = "python3 machineLearning/final_withTrainedModel.py $nitrogen $phosphorus $potassium $temperature $humidity $pH $rainfall 2>&1";
...
<div class="main-content">
    ...
    <div style="margin: 0px auto; font-size: 27px; font-weight: 600; text-transform: uppercase; padding: 10px;">
            Recommendation
        </div>
        <div class="row">
            <div class="col-md-7">
                <div class="card shadow" style="background-image: linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.5)),url('<?php echo $cropsImages[$recommended_crop]; ?>'); background-size: cover; background-position: center; border: none; height: 80vh;">
                    <div class="row">
                        <div class="col-md-12" style="margin-bottom: 60px; margin-top: 20px;">
                            <div class="row">
                                <div class="col-md-6" style="max-width: 100%;">
                                    <div class="crop-name" style="padding: 16px;">
                                        <h1 style="color: #fff; font-size: 40px; font-style: italic;-webkit-text-stroke: 0.7px black;">Rice</h1>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="description-title" style="padding: 15px; background-color: rgba(255, 255, 255, 0.4);">
                                <h2><strong>Crop Description</strong></h2>
                            </div>
                            <div class="description" style="padding: 18px; background-color: rgba(255, 255, 255, 0.5); height: 100%;">
            ...
            <div class="card shadow-lg">
                ...
                <div class="btn text-center" style="padding: 10px; margin-left: 32%;">
                    <form method="post" action="saveData.php">
                        <button type="submit" name="save" class="btn btn-success" style="width: 110px; height: 50px;">Save</button>
                    </form>
                </div>
            </div>
        </div>
