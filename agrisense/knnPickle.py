...
def recommendation(N, P, k, temperature, humidity, ph, rainfall):
    ...
    confidence = prediction_prob[0][predicted_class[0] - 1]  # Adjust index for KNN
...
# predict, confidence = recommendation(90, 90, 43, 23, 87, 7, 100)
...
if predict[0] in crop_dict:
    ...
    result = crop_name + ", " + str(confidence) + ", " + season_suitability + ", K-Nearest Neighbor"
